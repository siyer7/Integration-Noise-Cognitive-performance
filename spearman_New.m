...
%     end
    ...
    % once we receive by-condition data, we compute PD differences between lowc(2) and highv(3) conditions
...
% extract data from table 'combine'
    ...
    %cond = combine(1,4);
    spearman = corr(acc,conf,'Type','Spearman');
